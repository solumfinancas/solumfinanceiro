...
export const Wallets: React.FC = () => {
  ...
  const totalCreditInvoices = useMemo(() => {
    return wallets
      ...
      .reduce((sum, w) => {
        const period = getOpenInvoicePeriod(w.closingDay || 1, w.dueDay || 15);
      ...
      <div className="h-full flex flex-col p-10 justify-between relative z-10">
        ...
        <div className="flex items-start justify-between">
          <div className="space-y-4 flex-1 mr-4">
            ...
            {wallet.observation && (
              <div className="flex">
                <span className="inline-block px-2 py-0.5 bg-white/10 rounded text-[7.5px] font-black uppercase tracking-wider text-white/60 whitespace-nowrap" title={wallet.observation}>
                  {wallet.observation}
                </span>
              </div>
            )}
